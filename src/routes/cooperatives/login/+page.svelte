<script>
  ...
  import logo from "$lib/assets/images/team-collab.svg"
  ...
  <div class="basis-full  flex justify-center px-5 ">
    <form class="w-full" method="POST" action="?/login">
     <div class="flex justify-center mb-5">
      <img class="w-56 lg:w-64 " src={logo} alt="collab-logo">
    </div>
    <h1 class="text-3xl lg:text-4xl  mb-2 text-center font-semibold mt-2">Sign In</h1>
    <p class="text-gray-400 text-center ">Sign in and manage your cooperative</p>
