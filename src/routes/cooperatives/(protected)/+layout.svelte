...
<script lang="ts">
  ...
  <main>
    ...
    <header class="navbar bg-base-100">
        <div class="flex-none">
          <button class="btn btn-square btn-ghost lg:hidden" on:click={toggleSidebar}>
      ...
      <div class:hidden={!isSidebarOpen} class="fixed top-0 w-screen  bg-base-300 bg-opacity-60 h-screen lg:hidden backdrop" style="z-index: 11;" on:click={handleSidebarClick} role="presentation">
