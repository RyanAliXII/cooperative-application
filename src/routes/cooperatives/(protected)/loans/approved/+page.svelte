<script lang="ts">
  ...
  <div>
      <h1 class="text-lg font-semibold mb-3 ml-1 text-gray-500">Approved Loans</h1>
              ...
              <table class="table w-full">
                ...
                <tbody>
                      {#each data.loans as loan }
                        ...
                        <td>
                          <button class="btn btn-secondary btn-outline" on:click={()=>{selectedLoan = loan; isDisburseLoanDialogOpen = true }}> <i class="fa-solid fa-hand-holding-dollar"></i></button>
