        ...
        <li>
          ...
          {#if sidebarState["registration"]}
            <div class="pl-10 mt-1 text-sm hover:bg-white">
              <a href="/app/cooperatives/register"> Add Cooperative </a>
            </div>

            <div class="pl-10 text-sm hover:bg-white">
              <a href="/app/cooperatives/"> Cooperative </a>
            </div>
            <div class="pl-10 text-sm hover:bg-white">
              <a href="/app/cooperatives/categories"> Categories</a>
            </div>
          {/if}
        </li>
        <li>
          ...
          {#if sidebarState["rewards"]}
            ...
            <div class="pl-10 mt-1 text-sm hover:bg-white">
              <a href="/app/rewards/criteria"> Criteria </a>
            </div>
            <div class="pl-10 text-sm hover:bg-white">
              <a href="/app/rewards/assign"> Assign Rewards </a>
            </div>
            <div class="pl-10 mt-1 text-sm hover:bg-white">
              <a href="/app/recognitions"> Recognitions </a>
            </div>
          {/if}
        </li>
        <li>
