...
<div
  class="container w-full rounded mb-8 flex flex-col gap-5 lg:flex-row mt-10"
>
  <div
  ...
  >
    ...
    <h2 class="text-3xl font-bold">
      PHP {stat.savings.toLocaleString(undefined, MONETARY)}
    </h2>
    <p>Savings</p>
  </div>
  <div
  ...
  >
    ...
    <h2 class="text-3xl font-bold">
      PHP {stat.shares.toLocaleString(undefined, MONETARY)}
    </h2>
    <p>Shares</p>
  </div>
  <div
  ...
  >
    <i class="fa-solid fa-money-bill-transfer" />
    <h2 class="text-3xl font-bold">
      PHP {stat.liquidity.toLocaleString(undefined, MONETARY)}
    </h2>
    <p>Liquidity</p>
  </div>
</div>
