  ...
  async up(queryInterface, Sequelize) {
    ...
    ( CASE WHEN COALESCE(dcp.financial_performance_points, 0) = 0 THEN
     ...
     + 
      ...
      rankings.org_mgmt_points ELSE COALESCE(dcp.org_management_points, 0) END ) + COALESCE(field_points.points)) as points, 
      ...
      + 
    (CASE WHEN COALESCE(dcp.org_management_points, 0) = 0 THEN 
      rankings.org_mgmt_points ELSE COALESCE(dcp.org_management_points, 0) END )) DESC
          ) rank_position,
